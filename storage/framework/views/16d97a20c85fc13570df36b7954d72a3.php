        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    ...
                    <form action="<?php echo e(route('student.register')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\perintis-didik-system\resources\views/student-sign-up.blade.php ENDPATH**/ ?>