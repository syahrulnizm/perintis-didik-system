    ...
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('index')); ?>"><span class="bs-icon-sm bs-icon-circle bs-icon-white shadow d-flex justify-content-center align-items-center me-2 bs-icon" style="color: rgb(255,255,255);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-mortarboard-fill">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('index')); ?>"><i class="fas fa-home"></i><span>&nbsp;<strong>Home</strong></span></a></li>
                <li class="nav-item"><a class="nav-link" href='about-us'><i class="fas fa-info-circle"></i><span>&nbsp;<strong>About us</strong></span></a></li>
                <li class="nav-item"><a class="nav-link" href='team'><i class="fas fa-users"></i><span>&nbsp;T<strong>eam</strong></span></a></li>
            </ul>
        </div>
    </div>
</nav><?php /**PATH C:\xampp\htdocs\perintis-didik-system-app\resources\views/frame/index-navbar.blade.php ENDPATH**/ ?>