    ...
    <section class="py-5">
        <div class="container py-4 py-xl-5">
            <div class="row gy-4 gy-md-0">
                ...
                <div class="col-md-6">
                    <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="<?php echo e(asset('img/illustrations/misi-visi-perintis-didik.png')); ?>"></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col">
                    <div class="card border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            ...
                            <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="<?php echo e(asset('img/illustrations/tutor.png')); ?>"></div><a class="btn btn-primary" role="button" href='tutor-sign-in'>Sign In</a>
                ...
                <div class="col">
                    <div class="card border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            ...
                            <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="<?php echo e(asset('img/illustrations/student.png')); ?>"></div><a class="btn btn-warning" role="button" href='student-sign-in'>Sign In</a>
                ...
                <div class="col">
                    <div class="card border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            ...
                            <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="<?php echo e(asset('img/illustrations/admin.png')); ?>"></div><a class="btn btn-primary" role="button" href='admin-sign-in'>Sign In</a>
...
</html><?php /**PATH C:\xampp\htdocs\perintis-didik-system-app\resources\views/index.blade.php ENDPATH**/ ?>