        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    ...
                    <form action="<?php echo e(route('tutor.register')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\perintis-didik-system\resources\views/tutor-sign-up.blade.php ENDPATH**/ ?>